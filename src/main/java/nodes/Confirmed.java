...
public class Confirmed extends GPNode {
	@Override
	...
	public void eval(final EvolutionState state, final int thread, final GPData input, final ADFStack stack, final GPIndividual individual, final Problem problem) {
		...
		data.num = ((CovidProblem) problem).dateToConfirmedMap.get(date) - ((CovidProblem) problem).dateToConfirmedMap.get(dayBeforeDate);
	}
}
